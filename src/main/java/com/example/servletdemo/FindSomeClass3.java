...
//            if(OutputStream.class.isAssignableFrom( types[i] ))
//            {
...
//                continue;
//            }
//            if (OutputStream.class.isAssignableFrom( parameterTypes[0] ))
//            {
//                System.out.print(String.format("%s\n  %s\n", clazz.getName(), method.toString()));
//            }
...
//            return;
//        }
        if (!java.io.Writer.class.isAssignableFrom(clazz)) {
            return;
        }
    ...
    public static void main(String[] args) {
        EnumerateFileFromDir("/Users/walkerzheng/.m2/repository/", ".jar");
    }
}